...
def test_solve_group_ridge_random_search_n_targets_batch(backend, n_targets_batch):
    _test_solve_group_ridge_random_search(
...
@pytest.mark.parametrize("backend", ALL_BACKENDS)
def test_solve_group_ridge_random_search_n_alphas_batch(backend, n_alphas_batch):
    _test_solve_group_ridge_random_search(
        backend=backend, n_alphas_batch=n_alphas_batch
    )


def _test_solve_group_ridge_random_search(
